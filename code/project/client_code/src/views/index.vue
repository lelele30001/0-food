...
.menu_scrollbar {
    width: 100%;
    background:url(http://clfile.zggen.cn/20250109/59d212a477ea43b49280ad0c30df24e2.gif);
    border-width: 0px;
    border-style: solid;
...
.menu_scrollbar .menu_view .el-menu-item::after,.menu_scrollbar .menu_view .el-sub-menu .el-sub-menu__title::after{
    content:'';
    height:3px;
    background:var(--theme);
    display:block;
...
.menu_scrollbar .menu_view .el-menu-item.is-active::after,.menu_scrollbar .menu_view .el-sub-menu .el-sub-menu__title.is-active::after,.first-item.el-sub-menu.is-active .el-sub-menu__title::after{
	transform:scaleX(1);
	transform-origin:0 0;
	color: var(--theme) !important;
}
.menu_scrollbar .menu_view .el-menu-item:hover::after,.menu_scrollbar .menu_view .el-sub-menu .el-sub-menu__title:hover::after{
	transform:scaleX(1);
	transform-origin:0 0;
	color: var(--theme) !important;
}
