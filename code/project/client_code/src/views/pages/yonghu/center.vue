    ...
    <div class="usersView">
      ...
      <div class="usersBox profile" v-if="tabIndex == 'profile'">
        ...
        >
          <el-row>
            <el-col :span="12">
              <el-form-item label="身高(cm)" prop="shengao">
                <el-input
                  class="list_inp"
                  v-model.number="userForm.shengao"
                  placeholder="请输入身高"
                  type="number"
                ></el-input>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item label="体重(kg)" prop="tizhong">
                <el-input
                  class="list_inp"
                  v-model.number="userForm.tizhong"
                  placeholder="请输入体重"
                  type="number"
                ></el-input>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item label="年龄" prop="nianling">
                <el-input
                  class="list_inp"
                  v-model.number="userForm.nianling"
                  placeholder="请输入年龄"
                  type="number"
                ></el-input>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item label="健身目标" prop="jianshenmubiao">
                <el-select
                  class="list_sel"
                  v-model="userForm.jianshenmubiao"
                  placeholder="请选择健身目标"
                  style="width: 100%"
                >
            ...
            <el-col :span="24">
              <el-form-item label="饮食禁忌" prop="yinsjijin">
                <el-input
                  class="list_inp"
                  v-model="userForm.yinsjijin"
                  placeholder="请输入饮食禁忌，多个用逗号分隔"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="每日热量需求(kcal)">
                <el-input
                  class="list_inp"
                  v-model.number="userForm.meirireliang"
                  placeholder="自动计算"
                  readonly
                ></el-input>
              </el-form-item>
          ...
          <div class="formModel_btn_box">
            <el-button class="formModel_confirm" @click="updateProfile"
              >保存档案</el-button
            >
          </div>
        </el-form>
...
const calculateCalories = () => {
  const { shengao, tizhong, nianling, xingbie, jianshenmubiao } =
    userForm.value;
  if (!shengao || !tizhong || !nianling || !xingbie || !jianshenmubiao) {
    return;
  }
  ...
  let bmr;
  if (xingbie === "男") {
    bmr = 10 * tizhong + 6.25 * shengao - 5 * nianling + 5;
  } else {
    bmr = 10 * tizhong + 6.25 * shengao - 5 * nianling - 161;
  }

  // 根据健身目标调整
  let factor;
  switch (jianshenmubiao) {
    case "增肌":
      factor = 1.1;
      break;
    case "减脂":
  ...
  userForm.value.meirireliang = Math.round(bmr * factor);
};
//保存档案
const updateProfile = () => {
